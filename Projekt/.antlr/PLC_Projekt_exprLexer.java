...
public class PLC_Projekt_exprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "READ", "WRITE", "IF", "ELSE", "WHILE", "BOOL", "MUL", 
			"DIV", "MOD", "ADD", "SUB", "OR", "AND", "EQ", "NEQ", "LT", "GT", "ASSIGN", 
	...
	public PLC_Projekt_exprLexer(CharStream input) {
		super(input);
